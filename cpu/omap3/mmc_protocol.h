...
#define MMC_CMD0	(INDEX(0)  | RSP_TYPE_NONE | DP_NO_DATA | DDIR_WRITE | MSBS_SGLEBLK  | BCE_DISABLE)
#define MMC_CMD1	(INDEX(1)  | RSP_TYPE_R3   | DP_NO_DATA | DDIR_WRITE | MSBS_SGLEBLK  | BCE_DISABLE)
#define MMC_CMD2	(INDEX(2)  | RSP_TYPE_R2   | DP_NO_DATA | DDIR_WRITE | MSBS_SGLEBLK  | BCE_DISABLE)
#define MMC_CMD3	(INDEX(3)  | RSP_TYPE_R1   | DP_NO_DATA | DDIR_WRITE | MSBS_SGLEBLK  | BCE_DISABLE)
#define MMC_SDCMD3	(INDEX(3)  | RSP_TYPE_R6   | DP_NO_DATA | DDIR_WRITE | MSBS_SGLEBLK  | BCE_DISABLE)
#define MMC_CMD4	(INDEX(4)  | RSP_TYPE_NONE | DP_NO_DATA | DDIR_WRITE | MSBS_SGLEBLK  | BCE_DISABLE)
#define MMC_CMD6	(INDEX(6)  | RSP_TYPE_R1B  | DP_NO_DATA | DDIR_WRITE | MSBS_SGLEBLK  | BCE_DISABLE)
#define MMC_CMD7_SELECT	(INDEX(7)  | RSP_TYPE_R1B  | DP_NO_DATA | DDIR_WRITE | MSBS_SGLEBLK  | BCE_DISABLE)
#define MMC_CMD7_DESELECT \
                        (INDEX(7)  | RSP_TYPE_NONE | DP_NO_DATA | DDIR_WRITE | MSBS_SGLEBLK  | BCE_DISABLE)
#define MMC_CMD8	(INDEX(8)  | RSP_TYPE_R1   | DP_DATA    | DDIR_READ  | MSBS_SGLEBLK  | BCE_DISABLE)
#define MMC_SDCMD8	(INDEX(8)  | RSP_TYPE_R7   | DP_NO_DATA | DDIR_WRITE | MSBS_SGLEBLK  | BCE_DISABLE)
#define MMC_CMD9	(INDEX(9)  | RSP_TYPE_R2   | DP_NO_DATA | DDIR_WRITE | MSBS_SGLEBLK  | BCE_DISABLE)
#define MMC_CMD12	(INDEX(12) | RSP_TYPE_R1B  | DP_NO_DATA | DDIR_WRITE | MSBS_SGLEBLK  | BCE_DISABLE)
#define MMC_CMD13	(INDEX(13) | RSP_TYPE_R1   | DP_NO_DATA | DDIR_WRITE | MSBS_SGLEBLK  | BCE_DISABLE)
#define MMC_CMD15	(INDEX(15) | RSP_TYPE_NONE | DP_NO_DATA | DDIR_WRITE | MSBS_SGLEBLK  | BCE_DISABLE)
#define MMC_CMD16	(INDEX(16) | RSP_TYPE_R1   | DP_NO_DATA | DDIR_WRITE | MSBS_SGLEBLK  | BCE_DISABLE)
#define MMC_CMD17	(INDEX(17) | RSP_TYPE_R1   | DP_DATA    | DDIR_READ  | MSBS_SGLEBLK  | BCE_DISABLE)
#define MMC_CMD23	(INDEX(23) | RSP_TYPE_R1   | DP_NO_DATA | DDIR_WRITE | MSBS_SGLEBLK  | BCE_DISABLE)
#define MMC_CMD24	(INDEX(24) | RSP_TYPE_R1   | DP_DATA    | DDIR_WRITE | MSBS_SGLEBLK  | BCE_DISABLE)
#define MMC_CMD25	(INDEX(25) | RSP_TYPE_R1   | DP_DATA    | DDIR_WRITE | MSBS_MULTIBLK | BCE_ENABLE )
#define MMC_ACMD6	(INDEX(6)  | RSP_TYPE_R1   | DP_NO_DATA | DDIR_WRITE | MSBS_SGLEBLK  | BCE_DISABLE)
#define MMC_ACMD41	(INDEX(41) | RSP_TYPE_R3   | DP_NO_DATA | DDIR_WRITE | MSBS_SGLEBLK  | BCE_DISABLE)
#define MMC_ACMD51	(INDEX(51) | RSP_TYPE_R1   | DP_DATA    | DDIR_READ  | MSBS_SGLEBLK  | BCE_DISABLE)
#define MMC_CMD55	(INDEX(55) | RSP_TYPE_R1   | DP_NO_DATA | DDIR_WRITE | MSBS_SGLEBLK  | BCE_DISABLE)
