...
int board_init(void)
{
	...
	gd->bd->bi_arch_number = MACH_TYPE_OMAP3630_EDP1; /* Linux mach id*/
...
#define MUX_DEFAULT_ES2()\
	...
	MUX_VAL(CP(GPMC_nCS4),      (OFF_IN_PD  | IDIS | PTU | EN  | M4)) /*GPO-55 */\
	MUX_VAL(CP(GPMC_nCS5),      (OFF_OUT_PD | IDIS | PTD | DIS | M4)) /*GPIO_56*/\
	MUX_VAL(CP(GPMC_nCS6),      (OFF_IN_PD  | IEN  | PTD | DIS | M4)) /*GPIO_57*/\
	MUX_VAL(CP(GPMC_nCS7),      (OFF_IN_PD  | IEN  | PTU | EN  | M1)) /*GPMC_IODIR*/\
	...
	MUX_VAL(CP(DSS_DATA0),      (OFF_OUT_PD | IDIS | PTD | DIS | M3)) /*DSS_DATA0 */\
	MUX_VAL(CP(DSS_DATA1),      (OFF_OUT_PD | IDIS | PTD | DIS | M3)) /*DSS_DATA1 */\
	MUX_VAL(CP(DSS_DATA2),      (OFF_OUT_PD | IDIS | PTD | DIS | M3)) /*DSS_DATA2 */\
	MUX_VAL(CP(DSS_DATA3),      (OFF_OUT_PD | IDIS | PTD | DIS | M3)) /*DSS_DATA3 */\
	MUX_VAL(CP(DSS_DATA4),      (OFF_OUT_PD | IDIS | PTD | DIS | M3)) /*DSS_DATA4 */\
	MUX_VAL(CP(DSS_DATA5),      (OFF_OUT_PD | IDIS | PTD | DIS | M3)) /*DSS_DATA5 */\
	...
	MUX_VAL(CP(CAM_FLD),        (OFF_OUT_PD | IDIS | PTD | DIS | M4)) /*GPIO_98*/\
	...
	/*Serial Interface*/\
	MUX_VAL(CP(UART3_CTS_RCTX), (OFF_IN_PD  | IEN  | PTD | EN  | M4)) /*GIO-163*/\
	...
	MUX_VAL(CP(McSPI1_CS2),     (OFF_OUT_PD | IDIS | PTD | DIS | M0)) /*NOR_DPD */\
	...
	MUX_VAL(CP(SYS_CLKOUT1),    (             IDIS | PTD | DIS | M0)) /*SYS_CLKOUT1  */\
...
#define MUX_TFT_ES2()\
	...
	MUX_VAL(CP(UART3_CTS_RCTX), (IEN  | PTD | EN  | M4)) /*GIO-163*/
