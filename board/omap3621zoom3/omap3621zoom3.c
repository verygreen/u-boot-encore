...
#define MUX_DEFAULT_ES2()\
	...
	MUX_VAL(CP(CAM_XCLKA),      (IEN  | PTD | DIS | M4)) /*gpio_96 LCD reset*/\
	MUX_VAL(CP(CAM_PCLK),       (IEN  | PTD | DIS | M0)) /*CAM_PCLK*/\
	MUX_VAL(CP(CAM_FLD),        (IEN  | PTD | DIS | M4)) /*GPIO_98 */\
	MUX_VAL(CP(CAM_D0 ),        (IEN  | PTD | DIS | M7)) /*CAM_D0 Shorted signal on rev. 01 on SOM 3621*/\
	MUX_VAL(CP(CAM_D1 ),        (IEN  | PTD | DIS | M7)) /*CAM_D1 Shorted signal on rev. 01 on SOM 3621*/\
	...
	MUX_VAL(CP(UART1_CTS),      (IEN  | PTU | DIS | M7)) /*UART1_CTS*/\
	...
	MUX_VAL(CP(McSPI1_CS3),     (IDIS | PTD | DIS | M0)) /*hsusb2_data2 lab*/\
	/*hsusb2 lab */\
	MUX_VAL(CP(McSPI2_CLK),     (IDIS  | PTD | DIS | M0)) /**/\
	MUX_VAL(CP(McSPI2_SIMO),    (IDIS  | PTD | DIS | M0)) /**/\
	MUX_VAL(CP(McSPI2_SOMI),    (IDIS  | PTD | DIS | M0)) /*hsusb2_d5 lab*/\
	MUX_VAL(CP(McSPI2_CS0),     (IDIS  | PTD | DIS | M0)) /**/\
	MUX_VAL(CP(McSPI2_CS1),     (IDIS  | PTD | DIS | M0)) /*hsusb2_d3 lab*/\
	/*Control and debug */\
