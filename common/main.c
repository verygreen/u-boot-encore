...
static __inline__ int abortboot(int bootdelay)
{
    ...
    delaykey [] = {
        {
str:
            getenv ("bootdelaykey"),  retry: 1
        },
        {
str:
            getenv ("bootdelaykey2"), retry: 1
        },
        {
str:
            getenv ("bootstopkey"),   retry: 0
        },
        {
str:
            getenv ("bootstopkey2"),  retry: 0
        },
    };
...
static void Encore_boot(void)
{
    ...
    if(cap_ok) {
        ...
        if 	(key_pad&HOME_KEY && (gpio_pin_read(14))) {
            mode_idx = 1;
            lcd_console_setpos(20, 25);
            lcd_puts(" Booting into recovery...");
        }	// recovery boot
            ...
            lcd_console_setpos(20, 25);
            setenv("customboot", "0");
            lcd_puts("Booting into alternate...");
        }	// alt boot
