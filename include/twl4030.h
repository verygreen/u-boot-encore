...
/* RTC - note reg are register offsets from base*/
...
#define RTC_WEEKS_REG   0x06 
#define RTC_ALARM_SECONDS_REG   0x07 
#define RTC_ALARM_MINUTES_REG   0x08 
#define RTC_ALARM_HOURS_REG     0x09 
#define RTC_ALARM_DAYS_REG      0x0A 
#define RTC_ALARM_MONTHS_REG    0x0B 
#define RTC_ALARM_YEARS_REG     0x0C 
#define RTC_CTRL_REG        0x0D 
#define RTC_STATUS_REG      0x0E 
#define RTC_INTERRUPTS_REG  0x0F 

#define RTC_IRQ_IT_ALARM 		0x08
#define RTC_IRQ_IT_TIMER 		0x04
#define RTC_IRQ_EVERY_MASK		0x03
#define RTC_IRQ_MASK			0x0f

#define RTC_STATUS_POWER_UP 	0x80
#define RTC_STATUS_ALARM		0x40
#define RTC_STATUS_DAY_EVENT   0x20
#define RTC_STATUS_HOUR_EVENT  0x10
#define RTC_STATUS_MIN_EVENT   0x08
#define RTC_STATUS_SEC_EVENT   0x04
#define RTC_STATUS_RUN         0x02
#define RTC_STATUS_RTC_ALARM_ACK   0x40
