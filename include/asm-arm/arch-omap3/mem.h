...
#elif (defined(CONFIG_3621EDP1) || defined(CONFIG_3621ZOOM3)) && defined(CONFIG_SDRAM_MT46H32M32LFCM)
  #define SDP_SDRC_MDCFG_0_DDR	(0x03584099)	 /* Micron 1Gb SDRAM MT46H32M32LFCM module */
...
#define SDP_SDRC_MDCFG_0_DDR	(0x00D04019|B_ALL) /* Samsung MCP ddr module */
			...
			defined(CONFIG_SDRAM_HYNIX) || defined(CONFIG_3630EDP1) || \
			defined(CONFIG_SDRAM_HYNIX_SAMSUNG)
...
#elif defined(CONFIG_3621BOXER) && defined(CONFIG_SDRAM_ELPIDA_EDD20323ABH)
/*                                  MuxMode,  AddrLegacy, RamSize,    BankAloc,   B32Not16,    DeepPD,   DDRType,  RamType  */
  #define SDP_SDRC_MDCFG_0_DDR ((3 << 24) | (5 << 20) | (1 << 19) | (128 << 8) | (2 << 6) | (1 << 4) | ( 1 << 3) | (0 << 2) | (1 << 0))
#elif defined(CONFIG_3621EVT1A) && defined(CONFIG_SDRAM_SAMSUNG_K4X4G303PB)
/*                                  MuxMode,  AddrLegacy, RamSize,    BankAloc,   B32Not16,    DeepPD,   DDRType,  RamType  */
  #define SDP_SDRC_MDCFG_0_DDR ((0x3 << 24) | (0x5 << 20) | (1 << 19) | (128 << 8) | (0 << 6) | (1 << 4) | ( 1 << 3) | (0 << 2) | (1 << 0))
#else
...
#if defined(CONFIG_3430LABRADOR) || defined(CONFIG_BEAGLE_REV2) || defined(CONFIG_SDRAM_MICRON)
...
#define V_ACTIMA_200 V_ACTIMA_165
#define V_ACTIMB_200 V_ACTIMB_165

#elif (defined(CONFIG_3621EDP1) || defined(CONFIG_3621ZOOM3)) && defined(CONFIG_SDRAM_MT46H32M32LFCM)
/* Micron part of 3621 EDP1 (166MHz optimized) 6.02ns
 *     ACTIMA
 *        -TDAL = Twr/Tck + Trp/tck = 15/6 + 18/6 = 2.5 + 3 = 5.5 -> 6
 *        -TDPL (Twr) = 15/6       = 2.5 -> 3
 *        -TRRD = 12/6     = 2
...
#elif defined(CONFIG_SDRAM_HYNIX_SAMSUNG)
...
#elif defined(CONFIG_3621BOXER) && defined(CONFIG_SDRAM_ELPIDA_EDD20323ABH)
/* ELPIDA mDDR for Boxer & Pascal project (166MHz optimized) 6.02ns
 * Pascal : EDD20323ABH
 *     ACTIMA
...
#elif defined(CONFIG_3621EVT1A) && defined(CONFIG_SDRAM_SAMSUNG_K4X4G303PB)
/* Samsung mDDR for EVT R1A project (166MHz optimized) 6.02ns
 * Pascal : K4X4G303PB)
 *
 *     ACTIMA
...
#elif defined(CONFIG_SDRAM_ELPIDA)
/* ELPIDA mDDR for Pascal project (166MHz optimized) 6.02ns
 * Pascal : EDD20323ABH
 *     ACTIMA
 *        -TDAL = Twr/Tck + Trp/tck = 15/6 + 15/6 = 2.5 + 2.5 = 5
 *        -TDPL (Twr) = 15/6       = 2.5 -> 3
...
//DDR timings at 200MHZ and 166MHZ
# define SDP_SDRC_ACTIM_CTRLA_0_200     V_ACTIMA_200
# define SDP_SDRC_ACTIM_CTRLB_0_200     V_ACTIMB_200
# define SDP_SDRC_RFR_CTRL_200          ZOOM3_3630_RFR_CTRL_200MHz
# define SDP_SDRC_ACTIM_CTRLA_0     V_ACTIMA_165
# define SDP_SDRC_ACTIM_CTRLB_0     V_ACTIMB_165
# define SDP_SDRC_RFR_CTRL         SDP_3430_SDRC_RFR_CTRL_165MHz
#endif
...
# define LAB_ENET_GPMC_CONFIG6  0x1D0904C4
 /* L3_200MHZ */
# define M_NAND_GPMC_CONFIG1_200 0x00001800
# define M_NAND_GPMC_CONFIG2_200 0x00181800
# define M_NAND_GPMC_CONFIG3_200 0x00181800
# define M_NAND_GPMC_CONFIG4_200 0x12021202
# define M_NAND_GPMC_CONFIG5_200 0x020f1818
# define M_NAND_GPMC_CONFIG6_200 0x00000c80
# define M_NAND_GPMC_CONFIG7_200 0x00000870
# define P2_GPMC_CONFIG1_200  0x0
# define P2_GPMC_CONFIG2_200  0x0
# define P2_GPMC_CONFIG3_200  0x0
# define P2_GPMC_CONFIG4_200  0x0
# define P2_GPMC_CONFIG5_200  0x0
# define P2_GPMC_CONFIG6_200  0x0
# define LAB_ENET_GPMC_CONFIG1_200  0x00611000
# define LAB_ENET_GPMC_CONFIG2_200  0x001F1F01
# define LAB_ENET_GPMC_CONFIG3_200  0x00080803
# define LAB_ENET_GPMC_CONFIG4_200  0x1D091D09
# define LAB_ENET_GPMC_CONFIG5_200  0x041D1F1F
# define LAB_ENET_GPMC_CONFIG6_200  0x1D0904C4
# define STNOR_GPMC_CONFIG3  0x00060602
# define STNOR_GPMC_CONFIG4  0x11091109
# define STNOR_GPMC_CONFIG5  0x01141F1F
#endif
