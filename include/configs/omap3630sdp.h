...
#define CONFIG_3630SDP		1    /* working with SDP */

#define CONFIG_OMAP3430		1    /* 3630 is similar to 3430 */
...
#define CONFIG_COMMANDS		\
		((CFG_CMD_I2C | CONFIG_CMD_DFL | CFG_CMD_DHCP | \
...
#define CONFIG_BOOTARGS "mem=64M console=ttyS0,115200n8 noinitrd root=/dev/nfs"\
		" rw nfsroot=128.247.77.158:/home/a0393553/wtbu/rootfs ip=dhcp"
#else

#define CONFIG_BOOTARGS "root=/dev/ram0 rw mem=64M console=ttyS0,115200n8 "\
		"initrd=0x81600000,16M ramdisk_size=16384 rootfstype=ext2 "\
		"video=omap24xxfbout:rotatio=0 "
#endif
